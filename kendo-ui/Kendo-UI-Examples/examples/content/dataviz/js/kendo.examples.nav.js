    ...
    chart: [
        {
            ...
            items: [
                {
                    text: "Basic usage",
                    url: "bar-charts/unis_index.html"
                }, {
                    text: "Column chart",
            ...
            items: [
                {
                    text: "Basic usage",
                    url: "line-chart/unis_index.html"
                }, {
                    text: "Binding to remote data",
            ...
            items: [
                {
                    text: "Basic usage",
                    url: "scatter-charts/unis_index.html"
                }, {
